...
export default function Home() {
  ...
  if (!session) {
    ...
    return (
      ...
      {/* Search Section */}
      {search && (
          <div className="flex w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:max-w-xl dark:bg-gray-800 dark:border-gray-700">
